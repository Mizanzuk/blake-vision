...
export async function POST(req: NextRequest) {
  try {
    ...
    // Nota: A ficha de sinopse será criada automaticamente durante a extração em Upload
    // Não criamos aqui para evitar conflitos com a geração automática pela IA
