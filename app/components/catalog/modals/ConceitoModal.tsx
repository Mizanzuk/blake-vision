...
export default function ConceitoModal({
  isOpen,
  onClose,
  ficha,
  worlds,
  ...
  async function handleDelete() {
    ...
    const confirmed = window.confirm(
      "Tem certeza que deseja excluir este conceito? Esta ação não pode ser desfeita."
    );
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={ficha ? "Editar Conceito" : "Novo Conceito"}
      size="xl"
      footer={
        <>
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input
          ...
          placeholder="Digite o título do conceito"
          required
          fullWidth
        />
        ...
        <MentionTextarea
          ...
          placeholder="Escreva o conteúdo completo do conceito..."
          fullWidth
        />
      </form>
    </Modal>
