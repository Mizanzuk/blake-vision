...
export default function SinopseModal({
  isOpen,
  onClose,
  ficha,
  worlds,
  ...
  async function handleDelete() {
    ...
    const confirmed = window.confirm(
      "Tem certeza que deseja excluir esta sinopse? Esta ação não pode ser desfeita."
    );
    ...
    try {
      ...
      toast.success("Sinopse excluída com sucesso!");
      onClose();
    } catch (error) {
      console.error("Error deleting ficha:", error);
      toast.error("Erro ao excluir sinopse");
    } finally {
      setIsDeleting(false);
    }
  }
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={ficha ? "Editar Sinopse" : "Nova Sinopse"}
      size="xl"
      footer={
        <>
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input
          ...
          placeholder="Digite o título da sinopse"
          required
          fullWidth
        />
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Breve descrição da sinopse"
            fullWidth
          />
        </div>
        ...
        <MentionTextarea
          ...
          placeholder="Escreva o conteúdo completo da sinopse..."
          fullWidth
        />
      </form>
    </Modal>
