...
export default function BaseFichaModal({
  isOpen,
  onClose,
  ficha,
  worlds,
  ...
  // Form state - campos comuns a todas as fichas
  ...
  }, [ficha, isOpen, worlds, categorySlug]);
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={title || (ficha ? `Editar ${categoryLabel}` : `Nova ${categoryLabel}`)}
      size="xl"
      footer={
        <>
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Campos específicos da categoria (children) */}
        {children}
      </form>
    </Modal>
  );
...
// Hook para usar o formData nos modais filhos
export function useBaseFichaForm() {
  return {
