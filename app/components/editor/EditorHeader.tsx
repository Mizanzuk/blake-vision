...
export function EditorHeader({
  ...
  return (
    <div className="sticky top-0 z-20 bg-light-base dark:bg-dark-base border-b border-border-light-default dark:border-border-dark-default">
      {/* Grid 3 colunas: A (esquerda) | B (centro) | C (direita) */}
      <div className="grid grid-cols-[auto_1fr_auto] gap-0 max-w-full px-4 md:px-8 py-4">
        
        {/* COLUNA A - Esquerda (Margem) */}
        <div className="w-16 md:w-20 flex items-center justify-center" />
        
        {/* COLUNA B - Centro (Conteúdo Principal) */}
        <div className="flex items-center justify-between gap-4 min-w-0">
          ...
          <button
            ...
            className={clsx(
              "hidden md:flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 flex-shrink-0",
              isMetadataSaved
          ...
          >
            ...
            <span className="text-sm font-medium whitespace-nowrap">Modo Foco</span>
          </button>
          
          {/* Centro: Avatares dos Agentes */}
        ...
        {/* COLUNA C - Direita (Menu de Opções) */}
        <div className="w-16 md:w-20 flex items-center justify-end">
          {isMetadataSaved && (
                ...
                <div className="absolute right-0 mt-2 w-56 rounded-lg shadow-lg bg-white dark:bg-dark-bg-secondary border border-border-light-default dark:border-border-dark-default z-50">
                  <div className="py-2">
                    ...
                    <button
                      onClick={() => {
                        if (currentTextoId) {
                          handleDelete(currentTextoId);
                          setShowOptionsMenu(false);
                        }
                      }}
                      className="w-full px-4 py-2 text-left flex items-center gap-3 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors border-t border-border-light-default dark:border-border-dark-default"
                    >
                      <svg className="w-5 h-5 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                      </svg>
                      <span className="text-sm text-red-600 dark:text-red-400">Deletar</span>
                    </button>
                  </div>
                </div>
              )}
