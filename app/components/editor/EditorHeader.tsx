...
export default function EditorHeader({
  ...
  return (
    <div className="sticky top-0 z-20 bg-light-base dark:bg-dark-base">
      {isMetadataSaved && (
        <>
          {/* ========== LINHA MAGENTA 1: Modo Foco + Avatares + Três Pontinhos ========== */}
          <div className="max-w-4xl mx-auto px-16 py-2">
          ...
          {/* ========== LINHA MAGENTA 2: Seta + Título ========== */}
          <div className="max-w-4xl mx-auto px-16 py-1">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-1 rounded hover:bg-light-overlay dark:hover:bg-dark-overlay text-text-light-secondary dark:text-dark-secondary transition-colors flex-shrink-0"
          ...
          {/* ========== LINHA MAGENTA 4: Botões B/I/Aa ========== */}
          {/* Nota: Linha 3 (metadados) será renderizada na página principal */}
          <div className="max-w-4xl mx-auto px-16 py-2 mt-2">
